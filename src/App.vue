    ...
    <v-main class="h-screen position-relative d-flex flex-column" style="padding-left: 80px; z-index: 10;">
      ...
      <v-app-bar height="64" color="transparent" flat class="flex-shrink-0 px-8">
        <div class="d-flex align-center ga-4">
          <h1
            class="text-h6 font-weight-bold bg-clip-text"
        ...
        <template #append>
          <div class="d-flex align-center ga-4">
            <div
              class="px-4 text-caption font-weight-bold rounded-pill"
            ...
            <v-avatar color="blue-darken-1" size="32" class="text-caption font-weight-bold text-white" style="box-shadow: 0 4px 12px rgba(37,99,235,0.4);">
              SJ
            </v-avatar>
          </div>
        </template>
      ...
      <div class="flex-1 overflow-y-auto pa-8 pt-4 custom-scrollbar">
        <div class="mx-auto pb-12 d-flex flex-column ga-8" style="max-width: 1800px;">
          ...
          <div class="d-flex flex-column flex-lg-row ga-8 align-start">
            ...
            <TabsContent
              :theme="theme"
              :active-creditor="activeCreditor"
            />

            <!-- Right Side Action Panel -->
            <ActionPanel
              :theme="theme"
              class-name="action-panel-width"
            />
          </div>
